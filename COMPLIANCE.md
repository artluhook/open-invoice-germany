...
- **EN 16931 Steuerkategorie:** `Z` (Nullsatz) — nicht `G` (Export/Waren), nicht `AE` (Reverse Charge/EU).
...
- **Abgrenzung zu `G` (Ausfuhrlieferung):** `G` = Warenexport § 4 Nr. 1 i.V.m. § 6 UStG (Gegenstand geht ins Drittland). `Z` = sonstige Leistung, bei der der Ort nach § 3a Abs. 2 im Ausland liegt — kein Warenexport.
